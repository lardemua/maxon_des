...
des_error des_set_temp_param(des_context *context, uint16_t address, bool lword, uint32_t value);

des_error des_read_temp_param(des_context *context, uint16_t address, bool lword, uint32_t *value);
